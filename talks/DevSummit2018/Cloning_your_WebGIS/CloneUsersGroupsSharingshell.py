...
try:
    source = GIS("https://gleneagle.esri.com:7443/arcgis", "portaladmin", "<insert_password_here>")
...
try:
    target = GIS("https://ps002233.esri.com/portal", "portaladmin", "<insert_password_here>", verify_cert=False)
except URLError as e:
